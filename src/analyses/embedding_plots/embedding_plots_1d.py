...
network_dir = "/home/student/Desktop/Groundeep/networks/uniform/idbn"
output_dir = "/home/student/Desktop/Groundeep/outputs/images_uniform/1D_MDS"
...
def plot_embeddings(emb, y, title="", colormap="viridis", save_path=None):
    ...
    y_plot = np.zeros_like(emb[:,0]) if emb.ndim == 2 else emb[:,1]
    sc = ax.scatter(emb[:, 0], y_plot , c=y, cmap=cmap, norm=norm, s=40)
...
for pkl_path in pkl_files:
    ...
    mds = MDS(n_components=1, max_iter=100, n_jobs=1, dissimilarity='euclidean', random_state=42)
